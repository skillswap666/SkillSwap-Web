...
export function HomePage() {
  ...
  useEffect(() => {
    const fetchUserStats = async () => {
      if (user) {
        try {
          // You can add API calls here to get user statistics
  ...
  const stats = [
    ...
    },
    {
      ...
      value: userStats.totalWorkshopsAttended,
      icon: BookOpen,
    ...
    },
    {
      ...
      value: userStats.totalWorkshopsHosted,
      icon: Target,
      color: 'text-accent',
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-3">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <span>{new Date(workshop.date).toLocaleTimeString()}</span>
                            </div>
                            <div className="flex items-center space-x-1">
